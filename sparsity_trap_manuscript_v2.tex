...
\begin{figure*}[p]
  \centering
  \includegraphics[width=0.50\textwidth]{figures/wsi/TSPAN8_2um_WSI_improved.png}\\[0.01cm]
  \textit{\scriptsize TSPAN8 (epithelial): +0.731 SSIM, 97.8\% sparsity}\\[0.1cm]

  \includegraphics[width=0.50\textwidth]{figures/wsi/CEACAM5_2um_WSI_improved.png}\\[0.01cm]
  \textit{\scriptsize CEACAM5 (epithelial): +0.701 SSIM, 98.0\% sparsity}\\[0.1cm]

  \includegraphics[width=0.50\textwidth]{figures/wsi/KRT8_2um_WSI_improved.png}\\[0.01cm]
  \textit{\scriptsize KRT8 (epithelial): +0.673 SSIM, 97.9\% sparsity}\\[0.1cm]

  \includegraphics[width=0.50\textwidth]{figures/wsi/EPCAM_2um_WSI_improved.png}\\[0.01cm]
  \textit{\scriptsize EPCAM (epithelial): +0.669 SSIM, 98.1\% sparsity}\\[0.1cm]

  \includegraphics[width=0.50\textwidth]{figures/wsi/MUC12_2um_WSI_improved.png}\\[0.01cm]
  \textit{\scriptsize MUC12 (secretory): +0.633 SSIM, 97.4\% sparsity}\\[0.1cm]

  \includegraphics[width=0.50\textwidth]{figures/wsi/JCHAIN_2um_WSI_improved.png}\\[0.01cm]
  \textit{\scriptsize JCHAIN (immune): +0.457 SSIM, 96.2\% sparsity}\\[0.1cm]

  \includegraphics[width=0.50\textwidth]{figures/wsi/VIM_2um_WSI_improved.png}\\[0.01cm]
  \textit{\scriptsize VIM (stromal): +0.181 SSIM, 92.8\% sparsity}
...
\begin{figure*}[p]
  \centering
  \includegraphics[width=0.28\textwidth]{figures/tiles/TSPAN8_tile_comparison.png}\\
  \textit{\tiny TSPAN8}\\[0.01cm]

  \includegraphics[width=0.28\textwidth]{figures/tiles/CEACAM5_tile_comparison.png}\\
  \textit{\tiny CEACAM5}\\[0.01cm]

  \includegraphics[width=0.28\textwidth]{figures/tiles/KRT8_tile_comparison.png}\\
  \textit{\tiny KRT8}\\[0.01cm]

  \includegraphics[width=0.28\textwidth]{figures/tiles/EPCAM_tile_comparison.png}\\
  \textit{\tiny EPCAM}\\[0.01cm]

  \includegraphics[width=0.28\textwidth]{figures/tiles/MUC12_tile_comparison.png}\\
  \textit{\tiny MUC12}\\[0.01cm]

  \includegraphics[width=0.28\textwidth]{figures/tiles/JCHAIN_tile_comparison.png}\\
  \textit{\tiny JCHAIN}\\[0.01cm]

  \includegraphics[width=0.28\textwidth]{figures/tiles/VIM_tile_comparison.png}\\
  \textit{\tiny VIM}
