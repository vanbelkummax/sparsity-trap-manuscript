...
\begin{figure*}[t!]
  ...
  \textit{TSPAN8 (tetraspanin-8): +0.731 SSIM, 97.8\% sparsity}\\[0.4cm]

  \includegraphics[width=0.95\textwidth]{figures/wsi/CEACAM5_2um_WSI_improved.png}\\[0.2cm]
  \textit{CEACAM5 (CEA): +0.701 SSIM, 98.0\% sparsity}\\[0.4cm]
