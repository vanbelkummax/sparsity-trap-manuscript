...
To validate predictions at subcellular scale, we present a high-resolution tile comparison (256$\times$256 pixels at 2$\mu$m resolution) of CEACAM5 expression showing fine-grained tumor architecture (Figure~\ref{fig:tiles}). This magnified region reveals epithelial boundaries and lumen structure completely lost in MSE predictions.

\begin{figure*}[t!]
  \centering
  \includegraphics[width=0.95\textwidth]{figures/tiles/CEACAM5_tile_comparison.png}
  \caption{\textbf{Glandular-scale validation at 2$\mu$m resolution.} High-magnification tile comparison (256$\times$256 pixels) of CEACAM5 (epithelial marker, +0.701 SSIM) reveals that Poisson captures fine-scale tumor gland architecture, epithelial boundaries, and lumen structure---spatial details completely lost in MSE predictions. Ground truth (left), MSE prediction (center), Poisson prediction (right).}
  \label{fig:tiles}
\end{figure*}
